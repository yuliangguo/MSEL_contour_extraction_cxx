// This is brcv/seg/dbdet/algo/dbdet_nms.h
#ifndef dbdet_nms_h
#define dbdet_nms_h
//:
//\file
...
public:
  ...
  dbdet_nms_params(double thresh=1.0, PFIT_TYPE pfit_type=PFIT_3_POINTS, unsigned margin=1, double rel_thresh=2.5, bool adaptive_thresh=false): 
...
protected:
  ...
  dbdet_nms_params::PFIT_TYPE parabola_fit_type_;  ///< flag for parabola fit method
...
public:
  ...
  dbdet_nms(const dbdet_nms_params& nsp, 
