// This is dbdet_curve_model.h
#ifndef dbdet_curve_model_h
#define dbdet_curve_model_h
//:
//\file
...
public:
  ...
  //: default constructor
  dbdet_curve_model(){}
  dbdet_curve_model(curve_type t) : type(t) {}

  //: copy constructor
  dbdet_curve_model(const dbdet_curve_model& other) { type = other.type; }

  //: destructor
  virtual ~dbdet_curve_model(){}
  ...
  //
  // virtual dbdet_curve_model* intersect(dbdet_curve_model* cm)=0;

  //: construct and return a curve model of the same type by transporting it to a new extrinsic anchor
  virtual dbdet_curve_model* transport(vgl_point_2d<double> /*pt*/, double /*theta*/){ return 0;}//temp :make it virtual

  //: construct and return a curve model of the same type by looking for legal transitions with another curve bundle
  virtual dbdet_curve_model* transition(dbdet_curve_model* /*cm*/, int& /*trans_k*/, int& /*trans_type*/, double & /*bundle_size*/){ return 0;}//temp :make it virtual
  ...
  virtual bool is_C2_with(dbdet_curve_model* /*cm*/){ return false; }

  //: are these two curve bundles C^1?
  virtual bool is_C1_with(dbdet_curve_model* /*cm*/){ return false; }
...
class dbdet_linear_curve_model_base : public dbdet_curve_model 
{
public:
  ...
  //: default constructor
  dbdet_linear_curve_model_base(): pt(0.0,0.0), theta(0) { type = LINEAR; }

  //: constructor 1
  dbdet_linear_curve_model_base(vgl_point_2d<double> new_pt, double new_theta): pt(new_pt), theta(new_theta) { type = LINEAR; }

  //: copy constructor 
  dbdet_linear_curve_model_base(const dbdet_linear_curve_model_base& other) : dbdet_curve_model(other)
  { pt = other.pt; theta = other.theta; }

  //: destructor
  virtual ~dbdet_linear_curve_model_base(){}
...
class dbdet_simple_linear_curve_model : public dbdet_linear_curve_model_base 
{
public:
  double min_theta, max_theta;   ///< range of theta (simple curve bundle)

  //: default constructor
  dbdet_simple_linear_curve_model(): min_theta(0.0), max_theta(0.0) {}

  //: destructor
  virtual ~dbdet_simple_linear_curve_model(){}
  ...
  //: copy constructor
  dbdet_simple_linear_curve_model(const dbdet_simple_linear_curve_model& other) : dbdet_linear_curve_model_base(other) 
  { min_theta = other.min_theta; max_theta = other.max_theta; }

  //: construct and return a curve model of the same type by intersecting with another curve bundle
  dbdet_simple_linear_curve_model* intersect(dbdet_simple_linear_curve_model * cm);
...
class dbdet_linear_curve_model : public dbdet_linear_curve_model_base 
{
public:
  ...
  //: default constructor
  dbdet_linear_curve_model(): dbdet_linear_curve_model_base(), ref_pt(0.0,0.0), ref_theta(0) { type = LINEAR; }

  //: destructor
  virtual ~dbdet_linear_curve_model(){}
  ...
  //: copy constructor
  dbdet_linear_curve_model(const dbdet_linear_curve_model& other) : dbdet_linear_curve_model_base(other) 
  { ref_pt = other.ref_pt; ref_theta = other.ref_theta; cv_bundle = other.cv_bundle; }

  //: construct and return a curve model of the same type by intersecting with another curve bundle
  dbdet_linear_curve_model * intersect(dbdet_linear_curve_model * cm);
...
class dbdet_CC_curve_model : public dbdet_curve_model 
{
public:
  ...
  //: default constructor
  dbdet_CC_curve_model(): pt(0.0,0.0), tangent(0.0), theta(0), k(0.0) { type = CC; }

  //: constructor
  dbdet_CC_curve_model(vgl_point_2d<double> new_pt, double new_tangent): pt(new_pt), tangent(new_tangent), theta(0), k(0.0) { type = CC; }

  //: destructor
  virtual ~dbdet_CC_curve_model(){}
  ...
  //: copy constructor
  dbdet_CC_curve_model(const dbdet_CC_curve_model& other) : dbdet_curve_model(other) 
  { cv_bundle = other.cv_bundle; pt = other.pt; tangent = other.tangent; theta = other.theta; k = other.k; }

  //: construct and return a curve model of the same type by intersecting with another curve bundle
  dbdet_CC_curve_model *intersect(dbdet_CC_curve_model * cm);
...
//const double dbdet_k_classes[7] = {-0.3, -0.2, -0.1, 0.0, 0.1, 0.2, 0.3};
//const double dbdet_k_classes[7] = {-0.01, -0.005, -0.002, 0.0, 0.002, 0.005, 0.01};
const double dbdet_k_classes[9] = { -0.2, -0.1, -0.05, -0.01, 0.0, 0.01, 0.05, 0.1, 0.2};

//: The circular arc curve model class (new model)
class dbdet_CC_curve_model_new : public dbdet_curve_model 
{
public:
  ...
  //: default constructor
  dbdet_CC_curve_model_new(): ref_pt(0.0, 0.0), ref_theta(0.0), pt(0.0,0.0), theta(0), k(0.0) { type = CC2; }

  //: constructor
  dbdet_CC_curve_model_new(vgl_point_2d<double> new_pt, double new_tangent): ref_pt(new_pt), ref_theta(new_tangent), pt(new_pt), theta(new_tangent), k(0.0) { type = CC2; }

  //: destructor
  virtual ~dbdet_CC_curve_model_new(){}
  ...
  //: copy constructor
  dbdet_CC_curve_model_new(const dbdet_CC_curve_model_new& other);

  //: construct and return a curve model of the same type by intersecting with another curve bundle
  dbdet_CC_curve_model_new *intersect(dbdet_CC_curve_model_new * cm);

  //: construct and return a curve model of the same type by transporting it to a new extrinsic anchor
  virtual dbdet_curve_model* transport(vgl_point_2d<double> pt, double theta);

  //: construct and return a curve model of the same type by looking for legal transitions with another curve bundle
  virtual dbdet_curve_model* transition(dbdet_curve_model* cm, int& trans_k, int& trans_type, double & bundle_size);

  //: construct and return a curve bundle of the same type by looking for legal transitions with another curve bundle
  dbdet_curve_model* consistent_transition(dbdet_curve_model* cm, int& trans_k, int& trans_type, double &gc_cost);

  //: construct and return a curve bundle of the same type by looking for legal C1 transitions with another curve bundle
  dbdet_curve_model* C1_transition(dbdet_curve_model* cm);
...
//
//  //: construct and return a curve model of the same type by intersecting with another curve bundle
//  virtual dbdet_curve_model* intersect(dbdet_curve_model* cm);
//
//  //: construct and return a curve model of the same type by transporting it to a new extrinsic anchor
//  virtual dbdet_curve_model* transport(vgl_point_2d<double> pt, double theta);
//
...
class dbdet_CC_curve_model_perturbed : public dbdet_CC_curve_model 
{
public:
  ...
  //: default constructor
  dbdet_CC_curve_model_perturbed(): dbdet_CC_curve_model(){}

  //: destructor
  virtual ~dbdet_CC_curve_model_perturbed(){}
  ...
  //: copy constructor
  dbdet_CC_curve_model_perturbed(const dbdet_CC_curve_model_perturbed& other) : dbdet_CC_curve_model(other)
  ...
  void compute_perturbed_position_of_an_edgel(dbdet_edgel* e,
                                              int per_ind,
                                              double dpos, double dtheta,
                                              vgl_point_2d<double>& pt);

  //: construct and return a curve model of the same type by intersecting with another curve bundle
  dbdet_CC_curve_model_perturbed* intersect(dbdet_CC_curve_model_perturbed* cm);
...
class dbdet_CC_curve_model_3d : public dbdet_curve_model 
{
public:
  ...
  //: constructor
  dbdet_CC_curve_model_3d(vgl_point_2d<double> new_pt, double new_tangent): 
    Kmin(1, 1, 0.0f), Kmax(1, 1, 0.0f), ref_pt(new_pt), ref_theta(new_tangent), pt(new_pt), theta(new_tangent), k(0.0) { type = CC3d; }

  //: destructor
  virtual ~dbdet_CC_curve_model_3d(){}

  //: Constructor 1: From a pair of edgels
  dbdet_CC_curve_model_3d(dbdet_edgel* e1, dbdet_edgel* e2, dbdet_edgel* ref_e, 
                           double dpos, double dtheta, 
  ...
  //: copy constructor
  dbdet_CC_curve_model_3d(const dbdet_CC_curve_model_3d& other);

  //: construct and return a curve model of the same type by intersecting with another curve bundle
  dbdet_CC_curve_model_3d* intersect(dbdet_CC_curve_model_3d* cm);
  ...
  //: compute the CC curve bundle for an edgel pair given expected errors
  void compute_curve_bundle(dbdet_edgel* e1, dbdet_edgel* e2, dbdet_edgel* ref_e, double dpos, double dtheta, double token_len, double max_k, bool adaptive);
  ...
  //: are these two curve bundles C^2?
  virtual bool is_C2_with(dbdet_curve_model* cm);

  //: are these two curve bundles C^1?
  virtual bool is_C1_with(dbdet_curve_model* cm);
...
class dbdet_ES_curve_model : public dbdet_curve_model 
{
public:
  ...
  //: default constructor
  dbdet_ES_curve_model(): pt(0.0,0.0), theta(0), k(0.0), gamma(0.0) { type = ES; }

  //: destructor
  virtual ~dbdet_ES_curve_model(){}
  ...
  //: copy constructor
  dbdet_ES_curve_model(const dbdet_ES_curve_model& other) : dbdet_curve_model(other) 
  { cv_bundle = other.cv_bundle; pt = other.pt; theta = other.theta; k = other.k; gamma = other.gamma; }

  //: construct and return a curve model of the same type by intersecting with another curve bundle
  dbdet_ES_curve_model* intersect(dbdet_ES_curve_model *cm);
  ...
  void compute_curve_bundle(vgl_polygon<double>& bundle, dbdet_int_params &params, 
...
class dbdet_ES_curve_model_perturbed : public dbdet_ES_curve_model 
{
public:
  ...
  //: default constructor
  dbdet_ES_curve_model_perturbed() : dbdet_ES_curve_model(){}

  //: destructor
  virtual ~dbdet_ES_curve_model_perturbed(){}
  ...
  //: copy constructor
  dbdet_ES_curve_model_perturbed(const dbdet_ES_curve_model_perturbed& other) : dbdet_ES_curve_model(other) 
  { 
  ...
  //: construct and return a curve model of the same type by intersecting with another curve bundle
  dbdet_ES_curve_model_perturbed* intersect(dbdet_ES_curve_model_perturbed* cm);
