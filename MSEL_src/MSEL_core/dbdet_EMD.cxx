// This is brcv/seg/dbdet/algo/dbdet_EMD.cxx
...
double dbdet_color_EMD(dbdet_color_sig *sig1, dbdet_color_sig *sig2, dbdet_flow* flow, int* flowsize)
{
...
// commented out by Nhon to fix compilation errors on Cygwin.
// someone should look at this code again if it is needed elsewhere.
...
//inline double dbdet_color_EMD(const dbdet_color_sig &sig1, const dbdet_color_sig &sig2, dbdet_flow& flow, int& flowsize)
